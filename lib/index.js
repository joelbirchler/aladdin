...
var writeCoverageReports = function() {
    ...
    var htmlReport = istanbul.Report.create('html', {dir: coverageReportPath + '/html'});
    htmlReport.writeReport(collector, true);

    var coberturaReport = istanbul.Report.create('cobertura', {dir: coverageReportPath + '/cobertura'});
    coberturaReport.writeReport(collector, true);
};
